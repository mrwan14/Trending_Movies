...
async function getTrending(dataType,callback){
  let {data}=await axios.get(`https://api.themoviedb.org/3/trending/${dataType}/week?api_key=76780030766e96951b66f7598e7a0ef4`);
      ...
      <div className="row">
        <div className="col-md-4 d-flex align-items-center">
          <div>
            ...
            <h2> Trending <br /> movies <br /> to watch right now </h2>
